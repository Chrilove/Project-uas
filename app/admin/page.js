...
import { getAllOrders, getOrderStatistics } from '@/app/lib/orders'; // FIXED: Corrected import name
import { getAllUsers } from '@/app/lib/auth';
...
export default function AdminDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Fetch order statistics - FIXED: Using correct function name
