...
export default function AdminOrdersPage() {
  ...
  const getPaginationButtons = () => {
    const buttons = [];
    const maxButtons = 5; // Maksimal 5 tombol pagination
    
    let startPage = Math.max(1, currentPage - Math.floor(maxButtons / 2));
    let endPage = Math.min(totalPages, startPage + maxButtons - 1);
    
    // Adjust jika tidak cukup tombol di kiri
                          ...
                          {currentOrders.length === 0 ? (
                            ...
                            currentOrders.map((order) => (
                              <tr key={order.id} className={order.paymentStatus === 'waiting_verification' ? 'table-warning' : ''}>
                                ...
                                <td>{order.resellerName}</td>
                                <td>{order.resellerEmail}</td>
                  ...
                  <div className="modal-body">
                    {actionType === 'detail' && (
                      <div>
                        ...
                        <div className="row mb-3">
                          <div className="col-md-6">
                            <strong>Phone:</strong> {selectedOrder.resellerPhone}
                          </div>
                          <div className="col-md-6">
                        ...
                        <div className="d-grid gap-2">
                          <button 
                            ...
                            onClick={() => handlePaymentUpdate(
                              ...
                              'paid', 
                              'confirmed', 
                              'Pembayaran telah diverifikasi dan pesanan dikonfirmasi'
                            )}
                          >
                            ✅ TERIMA PEMBAYARAN & KONFIRMASI PESANAN
                          </button>
                          <button 
                            ...
                            onClick={() => handlePaymentUpdate(
                              ...
                              'failed', 
                              'cancelled', 
                              'Pembayaran ditolak - bukti tidak valid'
                            )}
                          >
                        ...
                        <div className="d-grid gap-2">
                          {selectedOrder.status === 'pending' && selectedOrder.paymentStatus === 'paid' && (
                            <button 
                              ...
                              onClick={() => handleStatusUpdate(selectedOrder.id, 'confirmed', 'Pesanan dikonfirmasi')}
                            >
                              ✅ Konfirmasi Pesanan
                            </button>
                          )}
                          ...
                          {selectedOrder.status === 'confirmed' && (
                            <button 
                              ...
                              onClick={() => handleStatusUpdate(selectedOrder.id, 'shipped', 'Pesanan sedang dikirim')}
                            >
                              🚚 Kirim Pesanan
                            </button>
                          )}
                          ...
                          {selectedOrder.status === 'shipped' && (
                            <button 
                              ...
                              onClick={() => handleStatusUpdate(selectedOrder.id, 'delivered', 'Pesanan telah sampai')}
                            >
                              📦 Pesanan Sampai
                            </button>
                          )}
                          ...
                          {selectedOrder.status === 'delivered' && (
                            <button 
                              ...
                              onClick={() => handleStatusUpdate(selectedOrder.id, 'completed', 'Pesanan selesai')}
                            >
                              🎉 Selesaikan Pesanan
                            </button>
                          )}
